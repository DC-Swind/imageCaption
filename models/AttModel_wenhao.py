...
class AttModel(nn.Module):
    def __init__(self, opt):
        ...
        self.fc_embed = nn.Sequential(nn.Linear(self.fc_feat_size * 2, self.rnn_size),  ### wenhao * 2
                                    nn.ReLU(),
        ...
        self.denseLayer = nn.Linear(self.fc_feat_size * 17, self.fc_feat_size) 
####   xud
...
###   wenhao
    def forward(self, fc_feats, att_feats, seq):
        ...
        fc_feat,rcnn_fc_feats = Variable(fc_feats.data[:,:2048]), Variable(fc_feats.data[:,2048:])  ######## wenhao
        rcnn_fc_feats = self.denseLayer(rcnn_fc_feats)  ######## wenhao
        fc_feats = torch.cat((fc_feat ,rcnn_fc_feats ),1)  ### wenhao
    ...
    def sample_beam(self, fc_feats, att_feats, opt={}):
        ...
        for k in range(batch_size):
            ...
            state = self.init_hidden(beam_size, tmp_fc_feats)  ##### xud
                ...
                if t == 0: # input <bos>
                    ...
                    for vix in range(beam_size):
                        ...
                        for state_ix in range(len(new_state)):
                            ...
                            new_state[state_ix][1, vix] = state[state_ix][1, v['q']] ####  xud
                        new_state[2][vix] = state[2][v['q']]  ### xud
